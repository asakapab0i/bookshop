...
<div class="col-md-9">
  ...
  <div class="row">
                <div class="col-md-3">
                  <img alt="{0}" title="{0}" class="image-size thumbnail" src="<?php echo base_url() . 'assets/img/books_image/{image}' ?>">
                </div>
                <div class="col-md-9">
                   <strong><span class="text-center"><a href="<?php echo base_url() . 'book/view/' . '{product_id}/{product_url}' ?>" title="{0} by {1}">{0}</a></span></strong> <br/> by {1}
                    <br/>
                    <br/>
